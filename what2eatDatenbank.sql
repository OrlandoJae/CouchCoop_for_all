...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 01. Nov 2018 um 16:54
...
--
ALTER TABLE `gericht`
  MODIFY `idgericht` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT für Tabelle `zutat`
--
ALTER TABLE `zutat`
  MODIFY `idzutat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
